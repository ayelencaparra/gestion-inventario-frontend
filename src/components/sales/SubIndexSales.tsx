type SubIndexSales ={
    setSeccionActiva: React.Dispatch<React.SetStateAction<"listar" | "crear" | "eliminar"| null>>;
...
export function SubIndexSales ({setSeccionActiva, handleClean, setMensajeExito, seccionActiva, handleImageClick}:SubIndexSales){
    const cambiarDeSubSeccion = (section:"crear" | "listar"| "eliminar" | null) =>{
    ...
    return(
        <section className="container-subindex-salespage">
            <ul>
                <li>Ventas</li>
                <li 
